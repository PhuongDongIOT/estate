    ...
    return (
      <div>
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          {/* Lightbox Dialog */}
          <DialogContent className="max-w-3xl bg-white p-5 rounded-lg">
            {/* Close Button */}
            <button
              onClick={() => setOpen(false)}
              className="absolute top-3 right-3 bg-gray-800 text-white p-2 rounded-full hover:bg-gray-900 transition z-50"
            >
              <X className="w-5 h-5" />
            </button>
